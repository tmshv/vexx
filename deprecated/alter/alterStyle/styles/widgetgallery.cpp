    ...
    : QDialog(parent)
{
    ...
    styleComboBox->addItem("Dark Sex");
    styleComboBox->addItem("Norwegian Wood");
...
//! [3]
    ...
    QMenu *menu( menuBar->addMenu("lalala") );
    QMenu *menu2( menuBar->addMenu("lalala54") );
    menu->addAction("bong");
    menu->addAction("bong2");
    menu->addAction("bong3");
    menu2->addAction("bong");
    menu2->addAction("bong2");
    menu2->addAction("bong3");
...
//! [5] //! [6]
{
    if (styleName == "Dark Sex") {
        QApplication::setStyle(new ADarkStyle);
    } else if (styleName == "Norwegian Wood") {
